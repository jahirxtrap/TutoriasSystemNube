                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Comentarios Estudiante</h3>
                                </div>
                    ...
                    <div class="modal fade" id="replyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <p>Responder a: <b><span id="reply_name"></span></b></p>
                                <input type="hidden" id="reply_id" name="reply_id" />
                                <textarea class="form-control" rows="5" id="reply_message"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary btn-block" id="reply_button">Responder</button>
                            </div>
                            </div>
                        </div>
                    </div>
