        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content">
                    <a class="btn btn-primary" href="{% url 'add_student' %}" role="button">+ Agregar Estudiante</a> <br/>&nbsp;
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <a href="{% url 'edit_student' student.admin.id %}" class="btn btn-success">Editar</a> 
                                                <a href="{% url 'delete_student' student.admin.id %}" class="btn btn-danger">Eliminar</a>
                                            </td>
                                            </tr>
                                            {% endfor %}
