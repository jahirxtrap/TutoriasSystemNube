"""
Django settings for configTutorias project.
...
SECRET_KEY = 'django-insecure-3+yr#b3!sc=ipul2w8bfzp#_r)snj!kq#&a2#csj#-wamm)c#h'
...
WSGI_APPLICATION = 'configTutorias.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'databaseTP',
        'USER': 'jahir',
        'PASSWORD': 'Septiembre2002',
        'HOST': 'pispostgres.postgres.database.azure.com',  # Por ejemplo, 'postgres' si utilizas Docker Compose.
